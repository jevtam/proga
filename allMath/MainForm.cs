...
public partial class MainForm : Form
{
    ...
    private void CreateMenu()
    {
        ...
        ToolStripMenuItem integralCalculator = new ToolStripMenuItem("Вычисление интеграла");
        integralCalculator.Click += IntegralCalculator_Click;
        ...
        menuStrip.Items.Add(integralCalculator);
    ...
    private void IntegralCalculator_Click(object sender, EventArgs e)
    {
        new IntegralMethodsForm().Show();
    }
}